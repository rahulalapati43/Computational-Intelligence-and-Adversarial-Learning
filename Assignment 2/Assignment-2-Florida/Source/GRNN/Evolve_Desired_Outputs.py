...
def Procreate(population,parent_1,parent_2):
    ...
    for gene in range(0,len(population[parent_1])):
        delta = 0.5 * (population[parent_2][gene]-population[parent_1][gene])
        child_1_gene = random.uniform(population[parent_1][gene]-delta,population[parent_2][gene]+delta)
        child_1.append(child_1_gene)
        child_2_gene = random.uniform(population[parent_1][gene]-delta, population[parent_2][gene]+delta)
