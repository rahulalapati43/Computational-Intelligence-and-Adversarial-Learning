...
def evaluateFitness(raw_feature_file,CU_X,Y,child,num):
    transformed_file_name = raw_feature_file.split('.')[0] + "_EGA_Improvement_transformed_SEC_" + str(num) +".txt"
...
if __name__ == '__main__':
    ...
    output_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\SEC_SportsWriters_Features\Elitist_GA_Improvement_SEC_output.txt"
    ...
    for run in range(1, 11):
        ...
        plt.ylabel("Accuracy")
        plot_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\Plots" + "\EGA_Improvement_SEC_" + str(run) + ".png"
