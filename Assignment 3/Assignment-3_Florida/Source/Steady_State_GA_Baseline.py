...
def evaluateFitness(raw_feature_file,CU_X,Y,child,num):
    transformed_file_name = raw_feature_file.split('.')[0] + "_SSGA_transformed_" + str(num) + ".txt"
...
if __name__ == '__main__':
    ...
    output_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\CASIS-25_Features\Steady_State_GA_Baseline_output.txt"
    ...
    for run in range(1,11):
        ...
        plt.ylabel("Accuracy")
        plot_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\Plots" + "\SSGA_Baseline_" + str(run) + ".png"
