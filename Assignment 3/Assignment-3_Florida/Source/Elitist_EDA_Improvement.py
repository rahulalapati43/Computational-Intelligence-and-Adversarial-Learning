...
def evaluateFitness(raw_feature_file,CU_X,Y,child,num):
    transformed_file_name = raw_feature_file.split('.')[0] + "_EEDA_Improvement_transformed_" + str(num) +".txt"
...
if __name__ == '__main__':
    ...
    output_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\CASIS-25_Features\Elitist_EDA_Improvement_output.txt"
    ...
    for run in range(1, 11):
        ...
        plt.ylabel("Accuracy")
        plot_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\Plots" + "\EEDA_Improvement_" + str(run) + ".png"
