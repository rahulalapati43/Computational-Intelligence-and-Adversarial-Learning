...
def evaluateFitness(raw_feature_file,CU_X,Y,child,num):
    transformed_file_name = raw_feature_file.split('.')[0] + "_SSGA_transformed_SEC_" + str(num) + ".txt"
    ...
    # evalute fitness of the initial population
...
if __name__ == '__main__':
    ...
    output_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\SEC_SportsWriters_Features\Steady_State_GA_Baseline_SEC_output.txt"
    ...
    for run in range(1,11):
        ...
        plt.ylabel("Accuracy")
        plot_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_3\Plots" + "\SSGA_Baseline_SEC_" + str(run) + ".png"
