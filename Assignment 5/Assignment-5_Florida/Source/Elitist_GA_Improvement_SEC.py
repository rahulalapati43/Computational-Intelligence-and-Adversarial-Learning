...
if __name__ == '__main__':
    ...
    output_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_5\SEC_Outputs\Elitist_GA_Improvement_SEC_output.txt"
    ...
    for run in range(1, 11):
        ...
        plt.ylabel("Accuracy")
        plot_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_5\Plots" + "\EGA_Improvement_SEC_" + str(run) + ".png"
