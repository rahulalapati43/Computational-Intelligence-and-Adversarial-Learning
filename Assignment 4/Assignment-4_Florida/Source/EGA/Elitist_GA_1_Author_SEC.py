...
if __name__ == '__main__':
    ...
    output_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_4\SEC_SportsWriters_Features\Elitist_GA_1_Author_output.txt"
    output_file = open(output_file_name, 'w+')

    df_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_4\SEC_SportsWriters_Features\Elitist_GA_1_Author_df.txt"
    ...
    for run in range(1, 11):
        ...
        plot_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_4\Plots" + "\EGA_1_Author_SEC_" + str(run) + ".png"
