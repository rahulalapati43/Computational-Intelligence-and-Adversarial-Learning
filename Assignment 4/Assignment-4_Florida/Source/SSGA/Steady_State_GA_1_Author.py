...
def initializePopulation():
    ...
    for i in range(0,population_size):
        individual = []
        for j in range(0,95):
            individual.append(random.uniform(-0.333525365433,0.882717922865))
...
if __name__ == '__main__':
    ...
    output_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_4\CASIS-25_Features\Steady_State_GA_1_Author_output.txt"
    output_file = open(output_file_name,'w+')

    df_file_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_4\CASIS-25_Features\Steady_State_GA_1_Author_df.txt"
    ...
    for run in range(1,11):
        ...
        plot_name = "C:\Users\Buji\PycharmProjects\CI_Assignment_4\Plots" + "\SSGA_1_Author_" + str(run) + ".png"
